...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=edb56a36a8534e22a25a7daa3221c01f";
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WeatherActivity.this, "failed on fetch weather info", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String comfort = "comfort level: " + weather.suggestion.comfy.info;
